...
- **AI Act — scadenze aggiornate dall'Omnibus (Reg. UE 2026/1744, lug 2026):** divieti in vigore dal 2/2/2025, trasparenza dal 2/8/2026, obblighi per l'alto rischio All. III rinviati al **2/12/2027** (la classificazione resta). Per gli agenti la questione si sposta: più autonomia = più responsabilità del deployer. Un agente usato per valutare studenti o decidere accessi a percorsi ricade nell'**alto rischio** (All. III, istruzione): fuori dal perimetro dello Snodo.
...
5. **AI Act, artt. su obblighi dei deployer + All. III** in vista dell'applicazione degli obblighi alto rischio (2/12/2027, post-Omnibus).
