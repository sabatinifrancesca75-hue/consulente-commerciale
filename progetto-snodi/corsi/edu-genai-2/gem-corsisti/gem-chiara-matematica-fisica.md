# Gem "Prof MC" — versione rivista

**Chiara** · Matematica e Fisica · Liceo scientifico, classi 1ª–5ª
*Revisione a cura della formatrice — corso Edu-GenAI 2*

---

## Cosa è cambiato

**Due cose che hai inventato tu e che ho tenuto identiche, perché sono le migliori del gruppo.**

- **La regola delle due file.** Non hai chiesto genericamente Fila A e Fila B: hai definito **in che cosa devono essere equivalenti** — stesse competenze, cambiano parametri, contesti e formulazioni. Nessun altro è arrivato a questo livello di specificazione.
- **La Revisione sul tempo prova.** *«Verifica il bilanciamento del carico di lavoro rispetto al tempo prova»* è la domanda pratica che decide se una verifica funziona o no, ed è una cosa che solo un docente di matematica scrive.

**C'è però un pezzo che manca, ed è il più importante: la Gem non è ancorata ai tuoi file.** La tua regola dei Riferimenti dice *«basa i contenuti sui programmi ministeriali e sui testi di riferimento per il Liceo Scientifico»* — che è **il mare aperto**, non i tuoi documenti. Il risultato è che hai costruito un ottimo co-progettista generico, ma non *il Prof della tua materia*: il senso della Gem personale è proprio che risponda dai **tuoi** curricoli, dalle **tue** griglie, imitando i **tuoi** materiali. Ho aggiunto il blocco di ancoraggio in testa, dove pesa di più.

**Riscrivendo il template si erano perse tre righe, e sono proprio quelle nate dai vostri lavori di settembre:** soluzioni svolte passo passo, **ricalcolo esplicito di ogni risultato in griglia**, somma dei punteggi che torna col totale. Sono le tre che intercettano la griglia che dava 125 dove il risultato era 3, e l'esercizio con infinite soluzioni. Le ho rimesse e rinforzate con il controllo che ogni esercizio sia **ben posto**.

**Ho aggiunto due regole nuove:**
...
1. **Carica i file di conoscenza.** Per te è il passaggio decisivo, non di rito: è ciò che trasforma un buon assistente generico nel *tuo*. Serve soprattutto la **programmazione dipartimentale**, visto che le chiedi di usarne i criteri per le griglie.
2. **Collauda le due file:** fatti generare una verifica e poi **risolvi tu l'esercizio 1 di entrambe**. Se una delle due ti prende il doppio del tempo, la regola del collaudo va rinforzata.
3. **Collauda la griglia:** prendi un risultato a caso dalla griglia e **rifai il conto**. È il controllo che abbiamo visto mancare più spesso nei lavori di settembre.
4. **Collauda la fisica:** chiedile un problema e **verifica le unità di misura** di ogni passaggio intermedio.
