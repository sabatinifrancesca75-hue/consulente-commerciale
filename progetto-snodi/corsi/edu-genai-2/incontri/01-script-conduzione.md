...
- La demo dell'allucinazione va **prevista in anticipo**: testare il giorno prima un tema di nicchia che generi riferimenti falsi in modo affidabile.
- Nell'esercitazione l'obiettivo emotivo è che ognuno veda **la propria disciplina** tradita dall'IA: l'aneddoto personale vale più di ogni slide.
- Raccogliere i "falsi" trovati in un Doc condiviso: è il repertorio di esempi che si riusa negli incontri 4 e 5.
- Il modulo dati partecipanti (genere/età) serve per gli indicatori PNRR C10I*: farlo compilare **in aula**, non a casa.
- Tempi cuscinetto: se il blocco normativo sfora, tagliare la slide 7 a tre messaggi (piramide, valutazione al docente, art. 4) — il resto è nei materiali.

## Checklist pre-incontro

- [ ] Link Meet inviato agli iscritti; stanze per le coppie predisposte
- [ ] Cartella Drive del corso condivisa (materiali, 2 PDF per NotebookLM, Doc "Falsi trovati")
- [ ] Demo allucinazione collaudata con l'account d'istituto
- [ ] Registro presenze e modulo indicatori pronti
- [ ] Scheda 1 stampabile/linkabile nei materiali operativi
