...
| 17:10–17:22 | **Demo dal vivo** | Card 16: "spiegami il Romanticismo" vs C.R.A.F.T.+R per una quarta scientifico (con profili sintetici DSA/plusdotato) + 2 iterazioni live (domanda difficile; versione alta leggibilità). Se allucina: fermarsi e mostrarlo — "l'errore in diretta È la demo" | Gemini |
| 17:22–17:32 | Livelli e pattern | Card 17–19: Bloom + tassonomia inversa; Catena e Critico; Context Conveyor (4 frasi da taschino) | Deck |
...
- **Nel laboratorio l'obiettivo minimo resta uno:** un template funzionante a testa, nel formato standard, caricato nella Prompt-libreria (primo artefatto collettivo del corso). L'Esemplare few-shot è il passaggio che fa la differenza: insistere.
