# Timeline del Percorso Formativo — Edu-GenAI 2

**Didattica Aumentata e Data Literacy (18 ore)** — Formatrice: Prof.ssa Sabatini • Tutor: Prof. Bonelli — Settembre 2026 • Orario: 15:30–18:30
Ogni tappa chiude con la slide "Bussola internazionale 2026" (integrata nei deck).

## 📍 Tappa 1 — Le fondamenta etiche e normative
**Mercoledì 9 settembre** · Ambiente protetto e regole d'ingaggio
- **Nuclei:** architettura dei LLM (perché il modello "allucina" — con Bender: forma senza significato); quadro normativo GDPR, AI Act, DM 166/2025.
- **Operativo:** DPIA d'istituto; regola aurea "nessun dato personale di studenti negli strumenti IA"; esercitazione "Rompere e riparare".
- **Bussola:** UNESCO *Transforming Higher Education* (approccio antropocentrico); UNESCO IICBA/ICHEI *Digitalization in Africa* (l'ecosistema istituzionale come condizione); Racc. UNESCO etica IA §104. Dati in slide: TALIS 2024 (36% usa l'IA, 75% impreparati), Common Sense (20% ed-tech a norma privacy).

## 📍 Tappa 2 — L'ingegneria del prompt
**Venerdì 11 settembre** · Prompting per la progettazione didattica
- **Nuclei:** dal prompt elementare al materiale d'aula strutturato; few-shot e chain-of-thought.
- **Operativo:** avvio della Prompt-libreria condivisa; copyright e licenze degli output; demo del flusso agentico.
...
2. GEM 2026: mantenuto come lente di equità con nota esplicita che l'edizione non tratta l'IA; riferimento tecnologico corretto = GEM 2023.
3. "Ghost learners": riformulato in "discenti dipendenti dall'automazione" — il termine non risulta nelle fonti ufficiali della Digital Learning Week; se si vuole usarlo, attribuirlo genericamente al dibattito.
4. Aggiunta l'opportunità di calendario: la Digital Learning Week (8–11/9) coincide con la prima settimana del corso — invito lanciato all'incontro 1, restituzione all'incontro 2.
